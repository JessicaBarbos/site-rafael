  ...
  >
    ...
    >
      <Link
        ...
        class="text-white font-semibold focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
        >Dashboard</Link
      >
    ...
    <div
      ...
      style="
        background-image: url('https://images.unsplash.com/photo-1630752708689-02c8636b9141?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2490&q=80');
      "
    >
        ...
        <div class="row">
          <div class="col-md-8 mx-auto">
            <div class="text-center">
              <h1 class="text-white">Rafael Franchini</h1>
              <h3 class="text-white">CRECI 123125</h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card card-body shadow-blur mx-3 mx-md-4 mt-n6">
            ...
            <div class="col-lg-9 mx-auto py-3">
              <div class="row">
                <div class="col-md-4 position-relative">
                  <div class="p-3 text-center">
                    <h1 class="text-gradient text-info">
                      <span id="state1" countTo="70">10</span>+
                    </h1>
                    <h5 class="mt-3">Casas a venda</h5>
                    <p class="text-sm font-weight-normal">
                      Aqui você encontra a casa ideal
                    </p>
                  </div>
                ...
                <div class="col-md-4 position-relative">
                  <div class="p-3 text-center">
                    <h1 class="text-gradient text-info">
                      <span id="state2" countTo="15">08</span>+
                    </h1>
                    <h5 class="mt-3">Apartamentos</h5>
                    <p class="text-sm font-weight-normal">
                      Aqui você encontra o apartamento mais aconchegante
                    </p>
                  </div>
                  <hr class="vertical dark" />
                </div>
                <div class="col-md-4">
                  <div class="p-3 text-center">
                    <h1 class="text-gradient text-info" id="state3" countTo="4">
                      03
                    </h1>
                    <h5 class="mt-3">Terrenos</h5>
                    <p class="text-sm font-weight-normal">
                      O terreno dos seus sonhos esta aqui
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 mx-auto mt-md-0 mt-5">
              <div class="position-sticky" style="top: 100px !important">
                <h4 class="">
                  Presentation Pages for Company, Sign In Page, Author and
                  Contact
                </h4>
      ...
      <section class="py-7">
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-2 col-md-4 col-6 ms-auto"></div>
            <div class="col-lg-2 col-md-4 col-6"></div>
            <div class="col-lg-2 col-md-4 col-6"></div>
            <div class="col-lg-2 col-md-4 col-6 ms-lg-0 ms-md-auto"></div>
            <div
              class="col-lg-2 col-md-4 col-6 me-md-auto mx-md-0 mx-auto"
            ></div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-7 col-12 my-auto">
              ...
              <p class="pe-md-5 mb-4">
                ...
                . Check our latest Premium Bootstrap 5 UI Kit. Designed for
                those who like bold elements and beautiful websites. Made of
                hundred of elements, designed blocks and fully coded pages,
                Material Kit is ready to help you create stunning websites and
                webapps.
              </p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 me-lg-auto my-lg-auto text-lg-end mt-5">
              <a
                href="https://twitter.com/intent/tweet?text=Check%20Material%20UI%20Kit%20made%20by%20%40CreativeTim%20%23webdesign%20%23designsystem%20%23bootstrap5&url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fmaterial-kit"
              ...
              <a
                href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/material-kit"
              ...
              <a
                href="https://www.pinterest.com/pin/create/button/?url=https://www.creative-tim.com/product/material-kit"
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 mb-4 ms-auto">
            <div>
              <a href="https://www.creative-tim.com/product/material-kit"> </a>
