                ...
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                    <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                        <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuPages2"
                            href='/properties' data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="material-icons opacity-6 me-2 text-md">home_work</i>
                            Imóveis
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2">
                        <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuBlocks"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="material-icons opacity-6 me-2 text-md">attach_money</i>
                ...
                <div class="row">
                    <div class="col-lg-9 mx-auto py-3">
                        <div class="row">
                            <div class="col-md-4 position-relative">
                                <div class="p-3 text-center">
                                    <h1 class="text-gradient text-info"><span id="state1"
                                            countTo="70">10</span>+</h1>
                                    <h5 class="mt-3">Casas a venda</h5>
                                    <p class="text-sm font-weight-normal">Aqui você encontra a casa ideal</p>
                                </div>
                            ...
                            <div class="col-md-4 position-relative">
                                <div class="p-3 text-center">
                                    <h1 class="text-gradient text-info"> <span id="state2"
                                            countTo="15">08</span>+</h1>
                                    <h5 class="mt-3">Apartamentos</h5>
                                    <p class="text-sm font-weight-normal">Aqui você encontra o apartamento mais
                                        aconchegante</p>
                                </div>
                                <hr class="vertical dark">
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 text-center">
                                    <h1 class="text-gradient text-info" id="state3" countTo="4">03</h1>
                                    <h5 class="mt-3">Terrenos</h5>
                                    <p class="text-sm font-weight-normal">O terreno dos seus sonhos esta aqui</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="position-absolute top-0 end-0 p-2 z-index-1">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                                ...
                                                <g id="lock-black" stroke="none" stroke-width="1" fill="none"
                                                    fill-rule="evenodd">
                                                    <circle id="Oval" fill="#1F2937" cx="12"
                                                        cy="12" r="12"></circle>
                ...
                <div class="row pt-lg-6">
                    <div class="col-lg-3">
                        <div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
                            ...
                            <h6 class="text-secondary font-weight-normal pe-3">20+ Fully coded components that popup
